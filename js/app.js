...
const allenDonnetteHouse = {
  ...
  imgs: [
    ...
    './img/pre-painted-1-min.jpg',
    './img/pre-painted-2-min.jpg',
    './img/finished-outside-1-min.jpg',
    './img/finished-outside-2-min.jpg',
    './img/finished-outside-3-min.jpg',
    './img/finished-outside-4-min.jpg',
    './img/inside-1-min.jpg',
    './img/inside-2-min.jpg',
    './img/inside-3-min.jpg',
    './img/inside-4-min.jpg',
    './img/inside-5-min.jpg',
    './img/inside-6-min.jpg',
    './img/inside-7-min.jpg',
    './img/inside-8-min.jpg',
    './img/inside-9-min.jpg',
    './img/inside-10-min.jpg',
    './img/inside-11-min.jpg',
    './img/inside-12-min.jpg',
    './img/inside-13-min.jpg',
    './img/inside-14-min.jpg',
    './img/inside-15-min.jpg',
    './img/inside-16-min.jpg',
  ],
};
